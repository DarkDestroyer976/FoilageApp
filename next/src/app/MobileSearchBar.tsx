...
const MobileSearchBar: React.FC<SearchBarProps> = ({autoFillKeyword = '', autoFillLocation = ''}) => {
  ...
  return (
        ...
        <div style={{fontFamily:"Montserrat", fontWeight:500}} className= "flex grid grid-rows-3 gap-[2.0vw] p-[4vw] mx-[13vw] mb-[60vw] border text-[3.7vw] text-[#333333] bg-white rounded-[3vw] text-[2.70vw]">
